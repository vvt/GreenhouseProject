...
состояния контроллера по шине 1-Wire.
...
//----------------------------------------------------------------------------------------------------------------
#define RELAY_ON HIGH// уровень для включения реле
#define RELAY_OFF LOW // уровень для выключения реле
//----------------------------------------------------------------------------------------------------------------
...
{
  {6,  RELAY_OFF} // пин 6, начальное состояние LOW
 ,{A0, RELAY_OFF} // и т.д. 0 вместо номера пина - нет поддержки привязки канала к пину
 ,{A1, RELAY_OFF}
 ,{3,  RELAY_OFF}
 ,{A2, RELAY_OFF}
 ,{A3, RELAY_OFF}
