...
<p>
 <ul>
  <li>Отсылать данные в облачные сервисы (ThingSpeak и GardenBoss.ru);</li>
  <li>Управляться и настраиваться посредством конфигуратора и веб-интерфейса;</li>
  <li>Получать внешние команды с сервиса GardenBoss.ru;</li>
  <li>Транслировать топики и управляться по протоколу MQTT (в резработке);</li>
  ...
  <li>Работать с несколькими типами дисплеев - Nextion, LCD 128x64, 7'-TFT (в разработке);</li>
  ...
  <li>Собирать и накапливать информацию в виде как на локальныю SD-карту (в виде лог-файлов), так и в веб-интерфейсе (база SQLite3) и на сервисе GardenBoss.ru, что позволяет выводить статистику в виде графиков;</li>
