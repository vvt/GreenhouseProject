...
<p>
 <ul>
  ...
  <li>Собирать и накапливать информацию в виде как на локальныю SD-карту (в виде лог-файлов), так и в веб-интерфейсе (база SQLite3) и на сервисе <a href="http://gardenboss.ru" target="_blank">GardenBoss.ru</a>, что позволяет выводить статистику в виде графиков;</li>
