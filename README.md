...
<ul>
  ...
  <li>Определено ещё кучу всяких <b>USE_*</b>, поэтому, прошу вас - будьте внимательны с настройками прошивки, ибо перечислять их здесь все - анрил полный;</li>
  ...
  <li>К Меге у меня подключен как минимум один универсальный модуль, для тестирования работы по 1-Wire и RS-485.</li>
</ul>
