...
<p>
 <ul>
  <li>Отсылать данные в облачные сервисы (ThingSpeak и <a href="http://gardenboss.ru">GardenBoss.ru</a>);</li>
  <li>Управляться и настраиваться посредством конфигуратора и веб-интерфейса;</li>
  <li>Получать внешние команды с сервиса <a href="http://gardenboss.ru">GardenBoss.ru</a>;</li>
  <li>Транслировать топики и управляться по протоколу MQTT (в разработке);</li>
  ...
  <li>Гибко настраиваться с помощью системы правил;</li>
  ...
  <li>Собирать и накапливать информацию в виде как на локальныю SD-карту (в виде лог-файлов), так и в веб-интерфейсе (база SQLite3) и на сервисе <a href="http://gardenboss.ru">GardenBoss.ru</a>, что позволяет выводить статистику в виде графиков;</li>
...
<summary><b>Кликните, чтобы посмотреть...</b><br/><br/></summary>
  ...
  * Neoway M590 (или SIM800L) - не подключен, директива `USE_SMS_MODULE` закомментирована;
...
<h2>GSM-модуль (Neoway M590 или SIM800L)</h2>

В текущей версии используется GSM-модуль на базе чипа NEOWAY M590 (также поддерживается SIM800L). Если вы не хотите использовать управление по SMS - закомментируйте `USE_SMS_MODULE` в файле `Globals.h`. 
