...
//--------------------------------------------------------------------------------------------------------------------------------
// ВНИМАНИЕ: на ESP должна быть установлена AT-прошивка версии 0.40, не ниже !!!
...
// прошивка версии 0.40. Поменять на 20, если используется AT-прошивка версии 0.20
// ПОД ДРУГИМИ ВЕРСИЯМИ - НЕ ТЕСТИРОВАНО, ПОЭТОМУ ТОЛЬКО ДВА ЗНАЧЕНИЯ: 40 и 20 !!!!!!!
