...
//--------------------------------------------------------------------------------------------------------------------------------
#define USE_FEEDBACK_MANAGER // закомментировать, если не нужно использовать модуль обратной связи по положению окон  (отдельная железка)
#define FEEDBACK_MANAGER_WAIT_TIME 10000 // если в течение указанного кол-ва миллисекунд после старта контроллера не придёт информация
...
#define GSM_EVENT_FUNC serialEvent2 // функция для обработки событий входящего трафика для модуля
...
#define WIFI_EVENT_FUNC serialEvent1 // функция для обработки событий входящего трафика от модуля
