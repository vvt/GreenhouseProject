...
//#define USE_WIFI_REBOOT_PIN // закомментировать, если не надо управлять пином выключения питания при зависании модема
...
// настройки IoT
//--------------------------------------------------------------------------------------------------------------------------------
#define IOT_UPDATE_INTERVAL 900000 // через сколько миллисекунд посылать данные в IoT (900 000 - каждые 15 минут)
// НИЖЕ ДОБАВЛЯЕМ ДАТЧИКИ, ПОКАЗАНИЯ С КОТОРЫХ ОТПРАВЛЯТЬ В IoT
// каждый датчик добавляется в фигурных скобках, между датчиками - запятая.
// внутри фигурных скобок идут: тип, индекс, имя модуля, в котором датчик
#define IOT_SENSORS {StateTemperature,0,"STATE"}, {StateHumidity,0,"HUMIDITY"} // для примера - два датчика с двух разных модулей
...
#define THINGSPEAK_ENABLED // закомментировать, если не нужна поддержка ThingSpeak
...
#define THINGSPEAK_CHANNEL_KEY F("ABCDEF") // тут ключ записи на канал
