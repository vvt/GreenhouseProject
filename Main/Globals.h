...
//--------------------------------------------------------------------------------------------------------------------------------
// [DRIVE_DIRECT, DRIVE_MCP23S17, DRIVE_MCP23017]
#define WATER_DRIVE_MODE DRIVE_DIRECT // прямое управление пинами, также можно рулить через расширители портов 
...
// [DRIVE_DIRECT, DRIVE_MCP23S17, DRIVE_MCP23017]
#define WATER_PUMP_DRIVE_MODE DRIVE_DIRECT // прямое управление пином, также можно рулить через расширители портов 
...
// [DRIVE_DIRECT, DRIVE_MCP23S17, DRIVE_MCP23017]
#define WATER_PUMP2_DRIVE_MODE DRIVE_DIRECT // прямое управление пином, также можно рулить через расширители портов 
// адрес микросхемы MCP23S17, через которую рулим пином насоса (если управление в режиме DRIVE_MCP23S17)
