...
#define PH_PLUS_CHANNEL 2 // номер канала для повышения уровня pH
#define PH_MINUS_CHANNEL 3 // номер канала для понижения уровня pH
...
#define PH_MIX_PUMP_CHANNEL 4 // номер канала насоса перемешивания раствора
