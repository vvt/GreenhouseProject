...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//--------------------------------------------------------------------------------------------------------------------------------
// отладочный режим (КОНФИГУРАТОР НЕ ЗАПУСКАТЬ, ТОЛЬКО МОНИТОР ПОРТА!)
// Common debug mode (Don't use configuration software, only Port Monitor!)
//#define _DEBUG 
//--------------------------------------------------------------------------------------------------------------------------------
...
//--------------------------------------------------------------------------------------------------------------------------------
// отладочный режим LCD-модуля (КОНФИГУРАТОР НЕ ЗАПУСКАТЬ, ТОЛЬКО МОНИТОР ПОРТА!)
// LCD module debug mode (Don't use configuration software, only Port Monitor!)
//#define LCD_DEBUG 
//--------------------------------------------------------------------------------------------------------------------------------
...
//#define PH_DEBUG
//--------------------------------------------------------------------------------------------------------------------------------
// режим юнит-тестирования IoT-функционала, не раскомментировать без понимания того, что делаем.
// IoT unit test mode (Don't use configuration software, only Port Monitor!)
//#define IOT_UNIT_TEST 
//--------------------------------------------------------------------------------------------------------------------------------
